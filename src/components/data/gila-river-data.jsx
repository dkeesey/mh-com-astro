...
export default function GilaRiverData() {
    const data = {
        ...
        sources: [
            ...
            "John L. Dewitt, Final Report: Japanese Evacuation from the West Coast 1942 (1943)",
            "Records of the War Relocation Authority, National Archives",
            "Gila River Indian Community Archives"
        ]
    };

    return <CampResearchData {...data} />;
}